...
function coerceToError(e, errorType) {
    if (e instanceof Error) {
        return e;
    }
    return new NonError(e, errorType);
}
exports.coerceToError = coerceToError;
var NonError = (function (_super) {
    __extends(NonError, _super);
    function NonError(input, errorType) {
        _super.call(this);
        this.name = "NonError";
        if (!input) {
            input = "undefined " + error_reporter_base_1.ErrorType[errorType] + " thrown";
        }
        if (input.message) {
