...
(function (ErrorType) {
    ErrorType[ErrorType["Exception"] = 0] = "Exception";
    ErrorType[ErrorType["Rejection"] = 1] = "Rejection";
})(exports.ErrorType || (exports.ErrorType = {}));
var ErrorType = exports.ErrorType;
var defaultCrashOnErrorTypes = [ErrorType.Exception];
var ErrorReporter = (function () {
    function ErrorReporter(config) {
        this._packageInfo = config.packageInfo || { name: null };
        ...
        this.channels = [];
        this.crashOnErrorTypes = Array.isArray(config.crashOnErrorTypes)
            ? config.crashOnErrorTypes
            : defaultCrashOnErrorTypes;
    }
