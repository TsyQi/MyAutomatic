...
var UpdateFinishedEvent = /** @class */ (function (_super) {
    __extends(UpdateFinishedEvent, _super);
    function UpdateFinishedEvent(product, nickname, installationPath, success, log, rebootTiming) {
    ...
    UpdateFinishedEvent.prototype.getProduct = function () {
        return this._product;
    };
    return UpdateFinishedEvent;
}(operation_finished_event_1.OperationFinishedEvent));
exports.UpdateFinishedEvent = UpdateFinishedEvent;
//# sourceMappingURL=update-finished-event.js.map